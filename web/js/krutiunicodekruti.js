...
var modified_substring = x;
//document.getElementById("legacy_text").value  ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    var text_size = x.length;
    //document.getElementById("legacy_text").value.length ;
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      ...
      while (x.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }

     var modified_substring = x.substring ( sthiti1, sthiti2 )  ;
...
function Convert_to_Kritidev_010(x)
{
