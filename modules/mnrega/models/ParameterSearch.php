...
/**
 * ParameterSearch represents the model behind the search form about `app\modules\mnrega\models\Parameter`.
 */
class ParameterSearch extends Parameter
{
    ...
    {
        return [
            [['id', 'type', 'weight'], 'integer'],
            [['link', 'name_hi', 'name_en', 'description', 'unit'], 'safe'],
        ];
    }
