...
class MarkingBehavior extends Behavior
{
  ...
  public function events()
	...
	public function markToDesignationMultiple($request_id,$sender,$sender_name,$sender_mobileno,$sender_designation_type_id,$receiver_designation_type_id,$receiver,$receiver_name,$receiver_mobileno,$purpose,$canmark,$status,$statustarget,$deadline,$change=0)
	 {
