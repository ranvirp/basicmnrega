...
$this->registerJs(
   '$("document").ready(function(){ 
        $("#new_parameter-target").on("pjax:end", function() {
            $.pjax.reload({container:"#parameter-targets"});  //Reload GridView
        });
    });'
);
?>
<div class="bordered-form parameter-target-form">
  <div class="form-title">
    <div class="form-title-span">
        <span>Form for creating ParameterTarget</span>
    </div>
</div>
    ...
    <?= $model->showForm($form,"parameter_target") ?>
...
/*
try {
$x= Utility::rules()["app\modules\mnrega\models\ParameterTarget"][$changeattribute];
} catch (Exception $e) {$x=null;}
$modelArray=Yii::$app->request->post("ParameterTarget");
