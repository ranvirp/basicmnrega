...
$this->registerJs(
   '$("document").ready(function(){ 
        $("#new_panchayat").on("pjax:end", function() {
            $.pjax.reload({container:"#panchayats"});  //Reload GridView
        });
    });'
);
?>
<div class="bordered-form panchayat-form">
  <div class="form-title">
    <div class="form-title-span">
        <span>Form for creating Panchayat</span>
    </div>
</div>
    <?php $form = ActiveForm::begin([
    'layout' => 'horizontal',
    'action'=>Url::to(['/Panchayat/create']),
    'fieldConfig' => [
        'template' => "{label}\n{beginWrapper}\n{input}\n{hint}\n{error}\n{endWrapper}",
...
/*
try {
$x= Utility::rules()["app\modules\mnrega\models\Panchayat"][$changeattribute];
} catch (Exception $e) {$x=null;}
$modelArray=Yii::$app->request->post("Panchayat");
