...
<tr>
  ...
  <th><?= Html::a('Upload to nregaup.in',Url::to(['/api/pps/remote?mid=15&rmid=15&host=nregaup.in&access_token=']).Yii::$app->user->identity->auth_key)?> </th>
  <th><?=Html::a('View on nregaup.in','http://nregaup.in/mnrega/parameter/displaywc')?> </th>
</tr>
</table>
