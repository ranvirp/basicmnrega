...
$this->registerJs(
   '$("document").ready(function(){ 
        $("#new_request-type").on("pjax:end", function() {
            $.pjax.reload({container:"#request-types"});  //Reload GridView
        });
    });'
);
?>
<div class="bordered-form request-type-form">
  <div class="form-title">
    <div class="form-title-span">
        <span>Form for creating RequestType</span>
    </div>
</div>
...
/*
try {
$x= Utility::rules()["app\modules\mnrega\models\RequestType"][$changeattribute];
} catch (Exception $e) {$x=null;}
$modelArray=Yii::$app->request->post("RequestType");
