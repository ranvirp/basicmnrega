...
$this->registerJs(
   '$("document").ready(function(){ 
        $("#new_block").on("pjax:end", function() {
            $.pjax.reload({container:"#blocks"});  //Reload GridView
        });
    });'
);
?>
<div class="bordered-form block-form">
  <div class="form-title">
    <div class="form-title-span">
        <span>Form for creating Block</span>
    </div>
</div>
    ...
    <?= $model->showForm($form,"block_name") ?>
...
/*
try {
$x= Utility::rules()["app\modules\mnrega\models\Block"][$changeattribute];
} catch (Exception $e) {$x=null;}
$modelArray=Yii::$app->request->post("Block");
