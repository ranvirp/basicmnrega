...
echo \yii\helpers\Html::dropDownList('block',$block,\yii\helpers\ArrayHelper::map(\app\modules\mnrega\models\Block::find()->orderBy('name_en desc')->asArray()->all(),'code','name_en'),['id'=>'block']);
