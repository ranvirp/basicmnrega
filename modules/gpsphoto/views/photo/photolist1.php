...
echo \yii\helpers\Html::label('District');
...
echo \yii\helpers\Html::label('Block');
...
echo \yii\helpers\Html::label('Rating');
echo \yii\helpers\Html::dropDownList('rating',null,\app\modules\work\models\WorkRating::ratingOptions());
