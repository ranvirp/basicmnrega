...
?>
<div class="bordered-form work-progress-form">
  <div class="form-title">
    <div class="form-title-span">
        <span>Form for creating WorkProgress</span>
    </div>
</div>
    <?php $form = ActiveForm::begin([
    'layout' => 'horizontal',
    'action'=>Url::to(['/WorkProgress/create']),
    'fieldConfig' => [
        'template' => "{label}\n{beginWrapper}\n{input}\n{hint}\n{error}\n{endWrapper}",
    ...
    <?= $model->showForm($form,"exp") ?>

    <?= $model->showForm($form,"phy") ?>

    <?= $model->showForm($form,"fin") ?>

<?php
/*
try {
$x= Utility::rules()["app\modules\work\models\WorkProgress"][$changeattribute];
} catch (Exception $e) {$x=null;}
$modelArray=Yii::$app->request->post("WorkProgress");
