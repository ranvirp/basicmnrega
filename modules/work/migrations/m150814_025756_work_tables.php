...
class m150814_025756_work_tables extends Migration
{
   public function up()
    ...
    //exit;
     ...
     // $this->addForeignKey('work_agency_fkey','{{%work}}','agency_code','{{%agency}}','code');
     // $this->addForeignKey('work_work_type_fkey','{{%work}}','work_type_code','{{%work_type}}','code');
      //$this->addForeignKey('work_scheme_fkey','{{%work}}','scheme_code','{{%scheme}}','code');
