...
public static function statusNames()
{
 return 
   [
    ...
    {
        return $this->hasMany(RequestMarking::className(), ['request_id' => 'id']);
    }
                ...
                switch ($x)
                    {
                       ...
                       if (!Yii::$app->user->can('marktopo'))
                        ...
                        //find block -
                           ...
                           $designations=\app\modules\users\models\Designation::find()->where(['designation_type_id'=>$podtid])->all();
                       ...
                       if (!Yii::$app->user->can('marktopo'))
                        ...
                        //find block -
                           ...
                           $designations=\app\modules\users\models\Designation::find()->where(['designation_type_id'=>$cdodtid])->all();
                           foreach ($designations as $designation)
                           {
                           $receiver=$designation->id;
                           $receiver_designation_type_id=$designation->designation_type_id;
                       ...
                       if (!Yii::$app->user->can('marktopo'))
                        ...
                        //find block -
                           ...
                           $designations=\app\modules\users\models\Designation::find()->where(['designation_type_id'=>$dcmnregadtid])->all();
                           foreach ($designations as $designation)
                           {
                           $receiver=$designation->id;
                           $receiver_designation_type_id=$designation->designation_type_id;
        ...
        if (array_key_exists('designation',$markings) )
          {
                foreach ($markings['designation'] as $x=>$designation_id)
                    {
                           $designation=Designation::findOne($designation_id);
                           if ($designation)
                           {
                           $receiver=$designation->id;
                           $receiver_designation_type_id=$designation->designation_type_id;
