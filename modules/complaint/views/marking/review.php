...
<?php
 ...
 'action'=>Url::to(['/complaint/marking/review?id='.$id.'&markingid='.$markingid.'&accept='.$accept]),
     
 ]);
 ?>
 <?=$form->field($model,'reply')->textArea(['class'=>'hindiinput form-control','onclick'=>'js:hindiEnable()']) ?>
 <?=$form->field($model,'reply_type')->hiddenInput(['value'=>ComplaintReply::INSTRUCTION]) ?>
